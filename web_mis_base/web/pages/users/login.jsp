...
<head>
  ...
  <script type="text/javascript">
                ...
                function(data, status){
                  if (status == "success") {//http通信返回200
                    if (data.status == 0) {//业务处理成功
                        ...
                        $.cookie("ngse_user", data.staff_name, {expires:1,path:"/"});
                        $.cookie("ngse_ticket", data.ticket, {expires:1, path:"/"});
    ...
    $(document).ready(function(){
        $.cookie("ngse_user", null,{expires:0,path:"/"});
        $.cookie("ngse_ticket", null, {expires:0,path:"/"});
